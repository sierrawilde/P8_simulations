...
def RunKatydidSimulation(n_sims, working_dir, katydid_config_path, locust_config_path, snr, mean_slope, min_snr, remove_egg, snr_file_path=None):
    ...
    locust_binary_path = 'LocustSim'#'/host/locust_mc/build/bin/LocustSim'
...
if __name__ == "__main__":
    ...
    #         os.mkdir(working_dir)
        ...
        RunKatydidSimulation(args.n_sims, args.working_dir, new_katydid_config_path, new_locust_config_path, args.snr, args.min_event_snr, args.remove_egg, args.snr_file_path)
